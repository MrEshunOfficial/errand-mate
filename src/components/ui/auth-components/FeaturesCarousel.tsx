...
const features = [
  {
    ...
    description:
      "Connect with qualified individuals for a wide range of services—from tech support to tutoring, errands, and more.",
  ...
  },
  {
    ...
    description:
      "Hire helpers for various needs like running errands, setting appointments, or assisting with shopping and navigation.",
    icon: (
...
const FeaturesCarousel = () => {
  ...
  return (
    <div className="flex flex-col h-[95vh] overflow-y-scroll justify-between relative z-10 py-8 px-6 lg:py-10 lg:px-8 hide-scrollbar bg-gradient-to-b from-blue-50 to-gray-100 dark:from-slate-900 dark:to-slate-950 w-full">
      {/* Header section */}
      ...
      {/* Carousel section */}
      <div className="flex-grow flex flex-col justify-center relative mb-8 lg:mb-12">
          ...
          <AnimatePresence initial={false} custom={direction} mode="popLayout">
            ...
            >
              <Card className="bg-white/80 dark:bg-white/10 backdrop-blur-xl border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white h-full overflow-hidden shadow-lg dark:shadow-2xl rounded-2xl">
                ...
                <CardFooter className="flex justify-between pt-3 lg:pt-4 relative z-10">
                  <Button
                    variant="ghost"
